...
本文档的[英文原版在这里](https://github.com/futurice/ios-good-practices)，感谢[Futurice](https://github.com/futurice)组织卓越的工作，为我们提供这么优质的文档。
...
如果你不想使用信号、"期货"或类似的机制来代表你未来的数据，你也可以使用常规的 block 回调。但要记住，连接或者嵌套这样的 block 块，如在某个网络请求依赖于另一个的结果的情况下，就会迅速变得非常笨重 --- 这种情况通常被称为"回调地狱"。
...
### Debugging Provisioning 配置文件的调试
